    ...
    <body>
        ...
        <div class="conteudo">
            <div class="div-centralizada">
                <form id="formNovoCliente" method="post" action="${cp}/processaClientes">
                    ...
                    <table>
                        ...
                        <tr>
                          <a href="${cp}/formularios/cliente/listagem.jsp"><img src="${cp}/images/voltar.png" alt="Voltar" width="32px" height="32px" title="Voltar"/></a>
